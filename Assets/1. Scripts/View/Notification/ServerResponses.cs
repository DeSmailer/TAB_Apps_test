...
{
    //public static Dictionary<string, string> serverResponses = new Dictionary<string, string>()
    //{
    //    {"100", "Continue" },
    ...
    public static Dictionary<long, string> serverResponses = new Dictionary<long, string>()
    {
        {100, "Continue" },
        {101, "Switching protocols." },
        {103, "Early hints." },
